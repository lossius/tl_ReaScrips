-- @description Set up four instances of mono FX to process channels 1-4
-- @version 1.0
...
--[[ @details Utility for FX processing of first order ambisonics using four mono FXs

  1) Three new plugins are instantiated as copies of the currently selected one
  ...
  4) Input and output pins are set so that
    ...
    All instances pass audio to and from the first (left) channel of the plugin
...
function tl_AmbiProcess4ChannelsUsingFourMonoFXs()
...
-- Finally!
tl_AmbiProcess4ChannelsUsingFourMonoFXs()