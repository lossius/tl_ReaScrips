-- @description Set up 20 instances of mono FX to process channels 1-20
-- @version 1.0
...
--[[ @details Utility for FX processing of 3rd order ambisonics A-format using 20 mono FXs
...
function tl_AmbiProcess16ChannelsUsing20MonoFXs()
...
-- Finally!
tl_AmbiProcess16ChannelsUsing20MonoFXs()