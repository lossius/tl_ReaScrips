-- @description Set up 16 instances of mono FX to process channels 1-16
-- @version 1.0
...
--[[ @details Utility for FX processing of third order ambisonics using 16 mono FXs
...
function tl_AmbiProcess16ChannelsUsing16MonoFXs()
...
-- Finally!
tl_AmbiProcess16ChannelsUsing16MonoFXs()